...
const inputFields = [
  ...
  "ct31", "ct32", "ct33", "ct39", "ct40", "ct42", "ct43", "ct47", "ct48",
  "numMonths"
];
...
function updateResults() {
  ...
  if (!isNaN(values.numMonths)) {
    ...
    let abs_ct45 = 0 ;
    if(ct35 > 0) {
     ct44 = values.ct35 - values.ct37 + values.ct38 + values.ct39 - values.ct40 + values.ct43;
     ct45 = values.ct35 - values.ct37 + values.ct38 + values.ct39 - values.ct40 + values.ct43;
     abs_ct45 = Math.abs(ct45);
    }
    ...
    if (isNaN && ct35 < 0) document.getElementById("ct35").value = 0
    else document.getElementById("ct35").value = values.ct35.toLocaleString("en-US");
